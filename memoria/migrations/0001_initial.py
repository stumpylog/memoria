    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("edit_groups", models.ManyToManyField(related_name="%(class)s_editors", to="auth.group")),
                ("view_groups", models.ManyToManyField(related_name="%(class)s_viewers", to="auth.group")),
            ],
            options={
                "abstract": False,
            },
