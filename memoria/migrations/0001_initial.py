...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ("permissions_manager", django.db.models.manager.Manager()),
            ],
        ),
        migrations.CreateModel(
            name="ImageSource",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["content_type", "object_id"], name="objectperm_ct_obj_idx"),
        ),
        migrations.AddIndex(
            model_name="objectpermission",
            index=models.Index(fields=["content_type", "object_id", "user"], name="objectperm_ct_obj_user_idx"),
        ),
        migrations.AddIndex(
            model_name="objectpermission",
            index=models.Index(fields=["content_type", "object_id", "group"], name="objectperm_ct_obj_group_idx"),
        ),
        migrations.AddIndex(
            model_name="objectpermission",
            index=models.Index(fields=["can_view"], name="objectperm_can_view_idx"),
        ),
        migrations.AddIndex(
            model_name="objectpermission",
            index=models.Index(fields=["can_edit"], name="objectperm_can_edit_idx"),
        ),
        migrations.AddConstraint(
            model_name="objectpermission",
        ...
        migrations.AddConstraint(
            model_name="objectpermission",
            constraint=models.CheckConstraint(
                condition=models.Q(("can_view", True), ("can_edit", True), _connector="OR"),
