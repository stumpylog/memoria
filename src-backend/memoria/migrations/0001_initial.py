...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveBigIntegerField(
                        help_text="Size of the original file in bytes", verbose_name="file size in bytes"
                    ),
                ),
                ...
                (
                    "is_dirty",
                    models.BooleanField(
                        default=False, help_text="The metadata is dirty and needs to be synced to the file"
                    ),
                ),
                (
                    "deleted_at",
                    models.DateTimeField(
                        default=None, help_text="Date the image was deleted or None if it has not been", null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.CharField(
                        blank=True, max_length=2048, null=True, verbose_name="Optional description of the region"
                    ),
                ),
                (
            ...
            options={
                ...
                "constraints": [
                    models.CheckConstraint(
                        condition=models.Q(
                            ("day_valid", False), models.Q(("month_valid", False), _negated=True), _connector="OR"
                        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "country_code",
                    models.CharField(
                        db_index=True, help_text="Country code in ISO 3166-1 alpha 2 format", max_length=4
                    ),
                ),
                (
                    "subdivision_code",
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("country_code", "subdivision_code", "city", "sub_location"), name="unique-location"
                    )
                ],
            },
        ),
        ...
        migrations.AddField(
            ...
            name="tags",
            field=models.ManyToManyField(
                help_text="These tags apply to the image", through="memoria.TagOnImage", to="memoria.tag"
            ),
        ),
        migrations.CreateModel(
            name="UserProfile",
