...
class MemoriaAppConfig(AppConfig):
    ...
    def ready(self):
        ...
        from memoria.tasks import index_changed_image  # noqa: F401
        from memoria.tasks import index_moved_image  # noqa: F401
        from memoria.tasks import index_new_images  # noqa: F401
